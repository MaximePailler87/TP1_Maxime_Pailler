...
try:
    ...
    assert "You logged into a secure area!" in page.verif_message(),"La connexion a échoué"
    
    print("\n--- Phase 4: Déconnexion ---")
    page_log.click_logout()
    
    assert "You logged out of the secure area!" in page.verif_message(),"La déconnexion a échoué"
